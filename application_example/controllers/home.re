module Home
  def index(parameters, cookies)
    ...
    Ryan.view('layout', {~title: 'home', ~head: [['<script type="text/javascript" src="/js/', js, '.js"></script>'].join() | js in ['jquery-1.2.6.min', 'jquery.livequery.min', 'effects.core', 'ui.core.min', 'effects.highlight', 'jquery.jgrowl.min', 'app']].join(), ~contents: Ryan.view('home_index', {})})
